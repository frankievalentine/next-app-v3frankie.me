...
export default function About() {
  return (
    <Container title="About – Frankie Valentine">
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 w-full">
        ...
        <div className="mb-8 prose dark:prose-dark leading-6">
          ...
          <ul>
            <li>
              Twitter: <a href="https://twitter.com/v3frankie">@v3frankie</a>
            </li>
            <li>
              GitHub:{" "}
              <a href="https://github.com/frankievalentine">
                @frankievalentine
              </a>
            </li>
            <li>
              Website:{" "}
              <Link href="https://v3frankie.me">https://v3frankie.me</Link>
            </li>
            <li>
              LinkedIn:{" "}
              <a href="https://www.linkedin.com/in/frankievalentine">
                https://www.linkedin.com/in/frankievalentine
              </a>
            </li>
          </ul>
          <h2>Bio</h2>
          ...
          <div className="flex space-x-8">
            <a href="/avatar.jpg">
              <Image
                alt="Frankie Valentine headshot"
                width={400}
                quality={100}
                src={avatar}
            ...
            <a href="/avatar-bw.jpg">
              <Image
                alt="Frankie Valentine headshot in black and white"
                width={400}
                quality={100}
                src={avatarBW}
                className="rounded-md"
